...
IL_003c_1:
			{
				...
				NullCheck(L_25);
				VirtualActionInvoker1< uint8_t >::Invoke(35, L_25, L_26);
...
IL_0056_1:
			{
				...
				uint8_t L_35 = V_2;
				NullCheck(L_34);
				VirtualActionInvoker1< uint8_t >::Invoke(35, L_34, L_35);
...
IL_006f_1:
			{
				...
				NullCheck(L_38);
				VirtualActionInvoker1< uint8_t >::Invoke(35, L_38, L_42);
			}
...
IL_007c_1:
			...
			}
			{
				...
				L_47 = VirtualFuncInvoker0< ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(39, L_46);
				V_4 = L_47;
				goto IL_0096;
			}
		}
