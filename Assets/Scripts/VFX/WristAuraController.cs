...
public class WristAuraController : MonoBehaviour
{
    ...
    void ApplyMana(float m)
    {
        if (auraVFX != null)
        {
            ...
            if (auraVFX.HasFloat("ManaPct"))     auraVFX.SetFloat("ManaPct", m);
            if (auraVFX.HasFloat("SpawnRate"))    auraVFX.SetFloat("SpawnRate", Mathf.Lerp(0f, 100f, m));
            if (auraVFX.HasFloat("ParticleSize")) auraVFX.SetFloat("ParticleSize", Mathf.Lerp(0f, 1f, m));
            if (auraVFX.HasFloat("OrbitRadius"))  auraVFX.SetFloat("OrbitRadius", Mathf.Lerp(0f, 0.08f, m));
            if (auraVFX.HasFloat("RingAlpha"))    auraVFX.SetFloat("RingAlpha", ComputeAlpha(m));
            if (auraVFX.HasVector4("AuraColor"))  auraVFX.SetVector4("AuraColor", auraColor);
        }
