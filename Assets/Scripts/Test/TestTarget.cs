...
namespace ArcaneVR.Testing
{
    /// <summary>
    /// Debug target for the gesture spell prototype. Logs spell attributes and flashes by element.
    /// </summary>
    public class TestTarget : MonoBehaviour, ISpellTarget
    {
